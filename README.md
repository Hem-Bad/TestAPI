# TestAPI OpenAPI Specification
[![Build Status](https://travis-ci.com/Hem-Bad/TestAPI.svg?branch=master)](https://travis-ci.com/Hem-Bad/TestAPI)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://hem-bad.github.io/TestAPI/)
- [SwaggerUI](https://hem-bad.github.io/TestAPI/swagger-ui/)
- OpenAPI Raw Files: [JSON](https://hem-bad.github.io/TestAPI/openapi.json) [YAML](https://hem-bad.github.io/TestAPI/openapi.yaml)
